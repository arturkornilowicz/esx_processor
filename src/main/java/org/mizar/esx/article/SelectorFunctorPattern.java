...
public class SelectorFunctorPattern extends EsxElement {
    ...
    @Override
    public void process() {
        ESX_Processor.actions.actionSelectorFunctorPatternBeforeLoci(this);
        setLoci((Loci) EsxElementFactory.create(getElement().element("Loci")));
        ESX_Processor.actions.actionSelectorFunctorPatternAfterLoci(this);
    }
}
