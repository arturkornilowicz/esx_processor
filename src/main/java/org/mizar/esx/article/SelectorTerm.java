...
public class SelectorTerm extends EsxElement implements TermInterface {
    ...
    @Override
    public void process() {
        ESX_Processor.actions.actionSelectorTermBeforeArgumen(this);
        setArgument((TermInterface) EsxElementFactory.create(getElement().elements().get(0)));
        ESX_Processor.actions.actionSelectorTermAfterArgumen(this);
    }
}
