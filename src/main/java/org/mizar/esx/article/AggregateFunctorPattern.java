...
public class AggregateFunctorPattern extends EsxElement {
    ...
    @Override
    public void process() {
        ESX_Processor.actions.actionAggregateFunctorPatternBeforeLoci(this);
        setLoci((Loci) EsxElementFactory.create(getElement().element("Loci")));
        ESX_Processor.actions.actionAggregateFunctorPatternAfterLoci(this);
    }
}
